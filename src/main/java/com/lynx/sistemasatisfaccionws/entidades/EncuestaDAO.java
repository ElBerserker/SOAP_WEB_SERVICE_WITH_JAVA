...
public class EncuestaDAO {
    ...
    public List<EncuestaDTO> consutarEncuestas()
    ...
    public int[] obtenerNivelesDeSatisfaccion() throws ClassNotFoundException, SQLException {
        Conexion conexion = Conexion.obtenerInstancia();
        ...
        try {
            connection = conexion.getConecction();
            sentencia_sql = connection.prepareStatement(SQL_GET_LEVEL_SATISFACTION);
